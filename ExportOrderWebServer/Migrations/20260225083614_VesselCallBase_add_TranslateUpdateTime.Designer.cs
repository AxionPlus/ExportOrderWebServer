...
namespace ExportOrderWebServer.Migrations
{
    ...
    [Migration("20260225083614_VesselCallBase_add_TranslateUpdateTime")]
    partial class VesselCallBase_add_TranslateUpdateTime
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExportOrderEntites.ImportDocument.VesselCallBaseEntity", b =>
                {
                    ...
                    b.Property<string>("GoogleTableUrl")
                        .HasColumnType("text");
                    ...
                    b.Property<DateTime?>("PortOfLoadingDate")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<DateTime?>("TranslateUpdateTime")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("ExportOrderEntites.ImportVesselCall.ImportVesselCallDetail", b =>
                {
                    ...
                    b.HasOne("ExportOrderEntites.Catalog.LocationCatalog", "POL")
                        .WithMany()
                        .HasForeignKey("POLId");
