...
public class _ExcelUploadService : IDisposable
{
    ...
    public _ExcelUploadService(string filePath, IEnumerable<CntrTpSz> cntrTypes, IDocumentProvider documentProvider)
    {
        FilePath = filePath;
        CntrTypes = cntrTypes;
    ...
    public async Task<(List<ExportOrderRecord>, List<DocumentEntity>)> _ReadUploadingFile()
    {
